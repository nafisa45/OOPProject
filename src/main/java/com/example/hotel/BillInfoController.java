...
import static com.example.hotel.RoomController.roomList;
import static com.example.hotel.RoomController.rooms;
...
public class BillInfoController implements Initializable {
    ...
    private void createBill(String id) throws IOException {
        ...
        String totalDay = "";
        String totalPrice = "";
        String path = "/home/user/IdeaProjects/Hotel/res/";
