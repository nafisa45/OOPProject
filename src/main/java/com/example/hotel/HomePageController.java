...
public class HomePageController implements Initializable {
    ...
    public void createRoom(javafx.event.ActionEvent actionEvent) {
        try {
            ...
            aboutus.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            Pane = FXMLLoader.load(getClass().getResource("room.fxml"));
            setNode(Pane);
            room.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
    ...
    public void createCheckIn(javafx.event.ActionEvent actionEvent) {
        try {
            ...
            setNode(Pane);
            checkin.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void createCheckOut(javafx.event.ActionEvent actionEvent) {
        try {
            ...
            setNode(Pane);
            checkout.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void createCustomerBill(javafx.event.ActionEvent actionEvent) {
        try {
            ...
            setNode(Pane);
            bill.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void createDash(javafx.event.ActionEvent actionEvent) {
        try {
            ...
            setNode(Pane);
            dash.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void createAboutUs(javafx.event.ActionEvent actionEvent) {
        try {
            room.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            checkout.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            bill.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            checkin.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            dash.setStyle("-fx-background-color:  #ffffff; -fx-text-fill: #000000");
            Pane = FXMLLoader.load(getClass().getResource("aboutus.fxml"));
            setNode(Pane);
            aboutus.setStyle("-fx-background-color:  #ffd700; -fx-text-fill: #ffffff");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
